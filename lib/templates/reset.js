...
export function resetEmail({ name, otp, expiresInMinutes = 10 }) {
  const body = `
    <h1 style="margin:0 0 8px;font-size:22px;font-weight:700;color:#111827;">Reset your password</h1>
    <p style="margin:0 0 20px;color:#4b5563;font-size:14px;line-height:1.6;">
      Hi ${escapeHtml(name) || 'there'}, use the code below to reset your Ticketmaster password.
  ...
  `
  return emailLayout({
    preview: 'Reset your Ticketmaster password',
    body,
  })
}
