...
router.get('/', async (req, res) => {
  try {
    ...
    // Then strip any events whose start time has already passed —
    // single source of truth via filterVisibleEvents.
    const merged = filterVisibleEvents([...adminMerged, ...curatedMerged])
