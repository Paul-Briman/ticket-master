...
const OVERRIDABLE_FIELDS = [
  ...
  'badge',
  'badgeType',
  // Homepage editorial control. When featured=true, the homepage
  // pins the event to the top of its featuredSection lane, sorted
  // by featuredOrder ascending. Non-featured events keep the
  // section's natural order below any featured entries.
  'featured',
  'featuredSection',
  'featuredOrder',
]
